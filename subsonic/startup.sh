...
SUBSONIC_PIDFILE=
SUBSONIC_DEFAULT_MUSIC_FOLDER=/data/audio/music
SUBSONIC_DEFAULT_PODCAST_FOLDER=/data/audio/podcasts
SUBSONIC_DEFAULT_PLAYLIST_FOLDER=/data/audio/playlists
